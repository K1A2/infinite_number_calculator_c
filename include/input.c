...
void init_number_struct(Number *number, bool *is_positive_num, bool *is_decimal_show, bool is_decimal_show_value, bool *is_number_struct) {
...
ExpressHeadTail* read_and_anlyze(char *filename) {
    ...
    Number number, none; // 숫자를 표현하는 구조체, 빈 구조체
            ...
            if (detect_error_invalid_chracter(in_ch) == ERROR) { // 읽어온 문자가 숫자, 연산자, () 외에 다른 문자인지 여부
                ...
                if (is_digit(in_ch) == TYPE_DIGIT) { // 읽어온 문자가 숫자인지 여부
                    ...
                    if (!is_number_struct) {
                        ...
                        init_number_struct(&number, &is_positive_num, &is_decimal_show, false, &is_number_struct);
                    }
                    if (!is_decimal_show) {
                        ...
                        if (in_ch == '.') {
                            ...
                            if (!is_decimal_show) {
                                ...
                                if (!is_number_struct) {
                                    ...
                                    init_number_struct(&number, &is_positive_num, &is_decimal_show, true, &is_number_struct);
                                }
